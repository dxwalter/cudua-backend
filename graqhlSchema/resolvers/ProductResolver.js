...
module.exports = {
    ...
    Mutation: {
        ...
        CreateProductFromInstagram (parent, args, context, info) {
            ...
            let createNewProduct = new CreateProduct();
            return createNewProduct.createProductFromInstagram(args.name, args.price, args.category, args.subcategory, args.businessId, args.imagePath, args.description, userId)
